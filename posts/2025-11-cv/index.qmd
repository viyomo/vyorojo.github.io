...
![Mi pasión por los ecosistemas acuáticos nació en el Zoológico de Cali y continua hoy en la acuicultura en Argentina](salta1.png){width=6in}
...
Durante seis me encargué de la transcripción de historias clínicas de los animales (desde leones y tigrillos hasta aves nocturnas y reptiles), sino que me sumergí en un mundo que cambiaría el rumbo de mi vida profesional. 
...
::: {#vid-cern}
{{< video https://www.youtube.com/watch?v=Kcu0IzRqTc8 width="350" height="225" >}}
:::
...
En el acuario asesoré un primer trabajo sobre "metodologías de manejo en cautiverio de especies ornamentales", el cual ayudó a transformar mi perspectiva profesional. [enlace](https://catalogo.ut.edu.co/cgi-bin/koha/opac-detail.pl?biblionumber=24101&query_desc=su%3A%22PISCICULTURA%22) 

Participé en áreas relacionadas con la comunicación de la ciencia a través de mi participación en el programa televisivo "Exploradores por Naturaleza". Algunos de los temas tratados sobre el manejo de peces en cautiverio fueron: el Pirarucu (_Arapaima gigas_) [enlace](https://www.youtube.com/watch?v=HoLLUnYkFSI), Pez globo (_Sphoroides annulatus_) [enlace](https://www.youtube.com/watch?v=JNLxB7ZpwHs), Carpa común (_Cyprinus carpio_) [enlace](https://www.youtube.com/watch?v=bTgLn485s6M), Caballito de mar (_Hippocampus ssp.) [enlace](https://www.youtube.com/watch?v=7ljCr6lxKE4), Raya de rio [enlace](https://www.youtube.com/watch?v=7TV8EdpELN8), entre otros. Además contribuí con algunas publicaciones sobre animales en el "Zooletin" (publicación trimestral). <embed src="zooletin 65.pdf" type="application/pdf" width="90%" height="500px" />
...
Mi compromiso con el aprendizaje continuo me llevó a participar en entrenamientos en el Dallas World Aquarium <a href="dallas.pdf">PDF</a>
 y Shedd Aquarium, donde conocí técnicas avanzadas de mantenimiento de acuarios, sistemas de filtración y cuarentenas.

:::: {layout="[[1,1], [1]]"}

![Shedd Aquarium](shedd1.png)

![Mola en Fort Worth Zoo](mola1.png)

![Dallas World Aquarium](dallas2.png){width=7in}
...
En este camino de aprendizaje y conocimientos inicié el _Doctorado en ciencias naturales_ con una investigación en el campo de la acuicultura. [ver](https://weekend.perfil.com/noticias/pesca/buenas-noticias-para-3-lagunas-que-suman-pejerreyes.phtml)
